			...
			<div class="col-sm-3">
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						<h2 class="title text-center">LO ÚLTIMO DE NUESTRO BLOG</h2>
						<div class="single-blog-post">
							<h3>Mercancia exclusiva de Ryzen</h3>
							<div class="post-meta">
								<ul>
									<li><i class="fa fa-user"></i> Ediczon</li>
									<li><i class="fa fa-clock-o"></i> 1:33 pm</li>
									<li><i class="fa fa-calendar"></i> JUL 2, 2020</li>
								</ul>
								<span>
							...
							<a href="">
								<img src="https://1000marcas.net/wp-content/uploads/2020/03/Razer-logo.png" alt="">
							</a>
							<p>Logramos un convenio con Razer, una de las marcas mas reconocidad del mundo gamer. Esto nos permite tener mercancia exclusiva de dicha marca.</p>
							<a  class="btn btn-primary" href="">Leer mas.</a>
						</div>
						<div class="single-blog-post">
							<h3>GMercancia exclusiva de Hyperex</h3>
							<div class="post-meta">
								<ul>
									<li><i class="fa fa-user"></i> Ediczon</li>
									<li><i class="fa fa-clock-o"></i> 1:33 pm</li>
									<li><i class="fa fa-calendar"></i> JUN, 2020</li>
								</ul>
								<span>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
							...
							<a href="">
								<img src="https://logodownload.org/wp-content/uploads/2017/10/hyper-x-logo.png" alt="">
							</a>
							<p>Logramos un convenio con Razer, una de las marcas mas reconocidad del mundo gamer. Esto nos permite tener mercancia exclusiva de dicha marca.</p>
							<a  class="btn btn-primary" href="">Leer mas</a>
						</div>
